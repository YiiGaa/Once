package com.yiigaa.once.servicemodule.FillingParam;
...
public class FillingParam extends Link {
    ...
    public HashMap<String, Object> start(HashMap<String, Object> param){
        COMMON_LOGGER.DEBUG(param, "ServiceModule-FillingParam start");
        HashMap<String, Object> returnParam = doStart(param);
        COMMON_LOGGER.DEBUG(returnParam, "ServiceModule-FillingParam end");
        return returnParam;
    }
}
