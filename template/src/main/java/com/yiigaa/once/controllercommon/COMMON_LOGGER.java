...
public class COMMON_LOGGER {
    ...
    public static void INIT(HashMap<String, Object> moduleMap, String msg) {
        ...
        LOGGER.info(InnerOutputFormat(codePath, msg, passParam, "hide", "hide", "hide"));
    }

    private static String InnerOutputFormat(String codePath, String msg, String passParam, String returnParam, String moduleParam, String sessionSave) {
    ...
    public static void INFO(HashMap<String, Object> moduleMap) {
        InnerINFO(moduleMap, "", false, false, false, false);
    }
    public static void INFO(HashMap<String, Object> moduleMap, String msg) {
        InnerINFO(moduleMap, msg, false, false, false, false);
    }
    public static void INFO(HashMap<String, Object> moduleMap, String msg, boolean isShowpassParam) {
        InnerINFO(moduleMap, msg, isShowpassParam, false, false, false);
    }
    public static void INFO(HashMap<String, Object> moduleMap, String msg, boolean isShowpassParam , boolean isShowreturnParam) {
        InnerINFO(moduleMap, msg, isShowpassParam, isShowreturnParam, false, false);
    }
    public static void INFO(HashMap<String, Object> moduleMap, String msg, boolean isShowpassParam , boolean isShowreturnParam, boolean isShowsessionSave) {
        InnerINFO(moduleMap, msg, isShowpassParam, isShowreturnParam, isShowsessionSave,false);
    }
    public static void INFO(HashMap<String, Object> moduleMap, String msg, boolean isShowpassParam , boolean isShowreturnParam, boolean isShowsessionSave, boolean isShowmoduleParam) {
        InnerINFO(moduleMap, msg, isShowpassParam, isShowreturnParam, isShowsessionSave, isShowmoduleParam);
    }
    private static void InnerINFO(HashMap<String, Object> moduleMap, String msg, boolean isShowpassParam , boolean isShowreturnParam, boolean isShowsessionSave, boolean isShowmoduleParam) {
        ...
        String sessionSave = (isShowsessionSave||LOGGER.isDebugEnabled())&&(moduleMap!=null)?((JSONObject) moduleMap.get("sessionSave")).toString():"hide";
        ...
        LOGGER.info(InnerOutputFormat(codePath, msg, passParam, returnParam, moduleParam, sessionSave));
    }
    ...
    public static void DEBUG(HashMap<String, Object> moduleMap, String msg) {
        if(LOGGER.isDebugEnabled()){
            ...
            String sessionSave = (moduleMap == null)?"null":((JSONObject) moduleMap.get("sessionSave")).toString();
            String returnParam = (moduleMap == null)?"null":((JSONObject) moduleMap.get("returnParam")).toString();

            StackTraceElement stackTrace = Thread.currentThread().getStackTrace()[2];
            String codePath = stackTrace.getClassName()+".java,"+stackTrace.getMethodName()+","+stackTrace.getLineNumber();

            LOGGER.debug(InnerOutputFormat(codePath, msg, passParam, returnParam, moduleParam, sessionSave));
        }
    }
    ...
    public static void ERROR(HashMap<String, Object> moduleMap, String msg) {
        ...
        LOGGER.error(InnerOutputFormat(codePath, msg, passParam, returnParam, moduleParam, sessionSave));
    }
