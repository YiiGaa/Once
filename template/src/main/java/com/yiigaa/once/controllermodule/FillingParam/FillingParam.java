package com.yiigaa.once.controllermodule.FillingParam;
...
public class FillingParam extends Link {
    private HashMap<String, Object> doStart(HashMap<String, Object> param){
        ...
        try {
            ...
            returnParam.put("errorCode", "MODULE_FillingParam_exception");
    ...
    public HashMap<String, Object> start(HashMap<String, Object> param){
        COMMON_LOGGER.DEBUG(param, "ControllerModule-FillParam start");
        HashMap<String, Object> returnParam = doStart(param);
        COMMON_LOGGER.DEBUG(returnParam, "ControllerModule-FillParam end");
        return returnParam;
    }
}
